[![Build Status](https://dev.azure.com/klemensarabiya/Test/_apis/build/status/Devklem.test?branchName=master)](https://dev.azure.com/klemensarabiya/Test/_build/latest?definitionId=1&branchName=master)
